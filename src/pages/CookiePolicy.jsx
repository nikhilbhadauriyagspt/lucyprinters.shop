...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This Cookie Policy explains how DashPrinterShop
 
   ("Company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://dashprintershop.shop/">https://dashprintershop.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@dashprintershop.shop">info@dashprintershop.shop</a></li>
        <li>Visiting: <Link to="/contact">https://dashprintershop.shop/contact</Link></li>
      </ul>
