...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This Cookie Policy explains how LucyPrinters
 
   ("Company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://lucyprinters.shop/">https://lucyprinters.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@lucyprinters.shop">info@lucyprinters.shop</a></li>
        <li>Visiting: <Link to="/contact">https://lucyprinters.shop/contact</Link></li>
      </ul>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          ...
          <p>United States</p>
          <p className="pt-4 text-blue-600 font-black lowercase">info@lucyprinters.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
